seqfile   = alinhamento_PAL2NAL_semgaps.phy        				* Path to the alignment file
treefile = Mx_arvore_label.tre    								* Path to the tree file
outfile = out_exercicio1_branch_M2.txt           						* Path to the output file
...
model  = 2                        								* One ω for all branches (M0 and site models) 
